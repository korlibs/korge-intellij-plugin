        ...
        override fun customizeRenderer(
            ...
            if (value is ThreeStateCheckedTreeNode) {
                ...
                if (feature is Feature) {
                    ...
                    textRenderer.isEnabled = !feature.always
                    tscheckbox.isVisible = true
                    //println("feature=$feature")
                    tscheckbox.state = when {
                        feature.always -> ThreeStateCheckBox.State.SELECTED
        ...
        set(value) {
            ...
            for ((group, gfeatures) in _features.groupBy { it.group }) {
                ...
                for (feature in gfeatures) {
                    root.add(ThreeStateCheckedTreeNode(feature).apply {
                        isChecked = false; featuresToCheckbox[feature] = this
                    })
                }
            }
