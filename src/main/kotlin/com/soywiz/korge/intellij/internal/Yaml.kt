...
private fun StrReader.readStringLit(reportErrors: Boolean = true): String {
...
private class ListReader<T> constructor(val list: List<T>, val ctx: T? = null) {
    private class OutOfBoundsException(val list: ListReader<*>, val pos: Int) : RuntimeException()
